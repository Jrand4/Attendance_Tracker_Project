...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2020 at 07:32 PM
...
--
ALTER TABLE `coursestudentabsence`
  MODIFY `courseStudentAbsenceID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `facultycourse`
  MODIFY `facultyCourseID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
