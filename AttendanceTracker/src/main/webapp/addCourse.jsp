<%-- 
    Document   : addCourse
    Created on : Mar 3, 2020, 1:56:04 PM
    Author     : xarro
--%>
...
<html>
  ...
  <body>
    ...
    %>
    <div class="title">
      Add Course for <%= session.getAttribute("userName")%>
    </div>
    ...
    <div class="content">
      <div class="courseList">
        <%
          String sql = "select course.* from course left join facultycourse on course.courseID = facultycourse.courseID where facultycourse.courseID is NULL order by courseTerm asc, courseCategory asc";
          DBConnect dbConnect = new DBConnect();
        %>
        <%= dbConnect.htmlAddCourseList(sql)%>
      </div>
    </div>
