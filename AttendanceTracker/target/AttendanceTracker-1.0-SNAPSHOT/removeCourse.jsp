<%-- 
    ...
    Created on : Mar 3, 2020, 1:55:55 PM
    Author     : xarro
--%>
...
<html>
  ...
  <body>
    ...
    %>
    <div class="title">
      Remove Course for <%= session.getAttribute("userName")%>
    </div>
    ...
    <div class="content">
      <div class="courseList">
        <%
          String sql = "select course.* from course inner join facultycourse on course.courseID = facultycourse.courseID, faculty,user where faculty.facultyID = facultycourse.facultyID and faculty.userID = user.userID and user.userUserName like '%" + session.getAttribute("userName") + "%' order by courseTerm asc, courseCategory asc";
          DBConnect dbConnect = new DBConnect();
        %>
        <%= dbConnect.htmlRemoveCourseList(sql)%>
      </div>
    </div>
    <h1>Hello World!</h1>
  </body>
