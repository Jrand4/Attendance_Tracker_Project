...
<html>
  ...
  <body>
    ...
    <div class="navbarleft" style="color: white;">
      <div class="navList">
        <a class="navListLink" href="ahomeLoggedIn.jsp">Home</a>
        <a class="navListLink" href="registerUser.jsp">Register New User</a>
        <a class="navListLink" href="registerCourse.jsp">Register Course</a>
        <a class="navListLink" href="advancedSettings.jsp">Advanced Settings</a>
      </div>
    </div>
